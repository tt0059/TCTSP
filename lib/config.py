...
__C.DATA_LOADER.TOPIC_LABEL_PATH = './data_vg/topic_labels'
...
__C.SCORER.TOPIC_GT_PATH = './data_vg/vg_train_topic_gts.pkl'
...
__C.PARAM.WT_TOPIC = 'WT_TOPIC'

__C.PARAM.SOFT_LABELS = 'SOFT_LABELS'

__C.PARAM.MAX_SEQS = 'MAX_SEQS'

__C.PARAM.ATTR_FEATS = 'ATTR_FEATS'

__C.PARAM.TOPIC_FEATS = 'TOPIC_FEATS'

__C.PARAM.P_ATTR_FEATS = 'P_ATTR_FEATS'
...
__C.PARAM.ATTN_LABELS = 'ATTN_LABELS'

__C.PARAM.TOPIC_LABELS = 'TOPIC_LABELS'

__C.PARAM.TOPIC_LABELS_HARD = 'TOPIC_LABELS_HARD'

__C.PARAM.STATE = 'STATE'

__C.PARAM.STATE_TOPIC = 'STATE_TOPIC'

__C.PARAM.OLD_STATE = 'OLD_STATE'

__C.PARAM.STACKED_SPATIAL = 'STACKED_SPATIAL'

__C.PARAM.SENT_INDEX = 'SENT_INDEX'

__C.PARAM.ACC_NUM = 'ACC_NUM'

__C.PARAM.ACC_DIFF = 'ACC_DIFF'
...
__C.PARAM.IMAGE_ID = 'IMAGE_ID'

__C.PARAM.WORD_EMBEDDING = 'WORD_EMBEDDING'

__C.PARAM.H_ATT = 'H_ATT'

__C.PARAM.PREVIOUS_TOPIC = 'PREVIOUS_TOPIC'

__C.PARAM.SUBSEQUENT_MAT = 'SUBSEQUENT_MAT'
# ---------------------------------------------------------------------------- #
# Inference options
# ---------------------------------------------------------------------------- #
__C.INFERENCE = edict()
...
__C.INFERENCE.TRAIN_ANNFILE = 'captions_val5k.json'
