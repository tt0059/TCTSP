...
if __name__ == "__main__":
    ...
    # input h5
    parser.add_argument('--infile', default='../mscoco/sent/coco_train_target_pkl', help='pkl file', type=str)
    parser.add_argument('--outfile', default='../mscoco/misc/coco_train_cider_pkl', help='output pickle file', type=str)
    ...
    #parser.add_argument('--infile', default='../data/teacher_target.pkl', help='pkl file', type=str)
    #parser.add_argument('--outfile', default='../data/coco_train_cider_teacher.pkl', help='output pickle file', type=str)
    #parser.add_argument('--gts', default='../data/coco_train_gts_teacher.pkl', help='output pickle file', type=str)
    #parser.add_argument('--image_ids', default='../mscoco/txt/coco_train_image_id.txt', help='image id file', type=str)    
