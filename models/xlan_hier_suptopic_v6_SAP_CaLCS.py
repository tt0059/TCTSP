...
from models.att_basic_model_hier_topic_v6_CaLCS import AttBasicModel_HIER_TOPIC_V6_CaLCS
import blocks
...
class XLAN_HIER_SUPTOPIC_V6_SAP_CaLCS(AttBasicModel_HIER_TOPIC_V6_CaLCS):
    def __init__(self,arg):
        super(XLAN_HIER_SUPTOPIC_V6_SAP_CaLCS, self).__init__()
        self.arg = arg
