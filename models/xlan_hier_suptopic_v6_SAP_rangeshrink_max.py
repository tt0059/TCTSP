...
from models.att_basic_model_hier_topic_v6_rangeshrink_max import AttBasicModel_HIER_TOPIC_V6_rangeshrink_max
import blocks
...
class XLAN_HIER_SUPTOPIC_V6_SAP_rangeshrink_max(AttBasicModel_HIER_TOPIC_V6_rangeshrink_max):
    def __init__(self,arg):
        super(XLAN_HIER_SUPTOPIC_V6_SAP_rangeshrink_max, self).__init__()
        self.arg = arg
