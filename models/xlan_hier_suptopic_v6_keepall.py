...
from models.att_basic_model_hier_topic_v6_keepall import AttBasicModel_HIER_TOPIC_V6_KEEPALL
import blocks

class XLAN_HIER_SUPTOPIC_V6_KEEPALL(AttBasicModel_HIER_TOPIC_V6_KEEPALL):
    def __init__(self):
        super(XLAN_HIER_SUPTOPIC_V6_KEEPALL, self).__init__()
