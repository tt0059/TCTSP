...
class AttBasicModel_HIER(BasicModel):
    def __init__(self):
        super(AttBasicModel_HIER, self).__init__()
    ...
    def make_kwargs(self, wt, gv_feat, att_feats, att_mask, p_att_feats, state, old_state, stacked_spatial, sent_index,  **kgs):
        kwargs = kgs
    ...
    def forward(self, **kwargs): 
        ...
        return outputs, stacked_spatial
