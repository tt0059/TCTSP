...
from models.att_basic_model_hier_topic_v6_slide_window import AttBasicModel_HIER_TOPIC_V6_slide_window
import blocks
...
class XLAN_HIER_SUPTOPIC_V6_SAP_slide_window(AttBasicModel_HIER_TOPIC_V6_slide_window):
    def __init__(self,arg):
        super(XLAN_HIER_SUPTOPIC_V6_SAP_slide_window, self).__init__()
        self.arg = arg
