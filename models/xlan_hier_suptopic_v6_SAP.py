...
from models.att_basic_model_hier_topic_v6 import AttBasicModel_HIER_TOPIC_V6
import blocks
...
class XLAN_HIER_SUPTOPIC_V6_SAP(AttBasicModel_HIER_TOPIC_V6):
    def __init__(self,arg):
        super(XLAN_HIER_SUPTOPIC_V6_SAP, self).__init__()
        self.arg = arg
