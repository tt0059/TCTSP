...
from models.att_basic_model_hier_topic_v6_keepout import AttBasicModel_HIER_TOPIC_V6_KEEPOUT
import blocks

class XLAN_HIER_SUPTOPIC_V6_KEEPOUT(AttBasicModel_HIER_TOPIC_V6_KEEPOUT):
    def __init__(self):
        super(XLAN_HIER_SUPTOPIC_V6_KEEPOUT, self).__init__()
