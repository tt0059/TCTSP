...
from models.att_basic_model_hier_topic_v6_abortall import AttBasicModel_HIER_TOPIC_V6_ABORTALL
import blocks

class XLAN_HIER_SUPTOPIC_V6_ABORTALL(AttBasicModel_HIER_TOPIC_V6_ABORTALL):
    def __init__(self):
        super(XLAN_HIER_SUPTOPIC_V6_ABORTALL, self).__init__()
    ...
    def Forward_Topic(self, **kwargs):
        ...
        ctx_word = state_word[1][0]  #now use 1,0 which is the ctx of word lstm;1 1 was not used in word-lstm, consider use it in topic
