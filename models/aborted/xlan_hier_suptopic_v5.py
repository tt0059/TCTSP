...
from models.att_basic_model_hier_topic_v5 import AttBasicModel_HIER_TOPIC_V5
import blocks

class XLAN_HIER_SUPTOPIC_V5(AttBasicModel_HIER_TOPIC_V5):
    def __init__(self):
        super(XLAN_HIER_SUPTOPIC_V5, self).__init__()
    ...
    def Forward_Topic(self, **kwargs):
        ...
        h_att, c_att = self.att_lstm(torch.cat([xt_word, old_state, gv_feat + self.ctx_drop(state_topic[0][1])], 1), (state_topic[0][0], state_topic[1][0]))
    ...
    def Forward_Word(self, **kwargs):
        ...
        h_att, c_att = self.watt_lstm(torch.cat([xt_word, old_state, gv_feat + self.wctx_drop(state_word[0][1])], 1), (state_word[0][0], state_word[1][0]))
