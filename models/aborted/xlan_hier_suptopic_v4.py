...
from models.att_basic_model_hier_topic_v4 import AttBasicModel_HIER_TOPIC_V4
import blocks

class XLAN_HIER_SUPTOPIC_V4(AttBasicModel_HIER_TOPIC_V4):
    def __init__(self):
        super(XLAN_HIER_SUPTOPIC_V4, self).__init__()
    ...
    def Forward_Word(self, **kwargs):
        ...
        h_att, c_att = self.watt_lstm(torch.cat([xt_word, self.wctx_drop(topic_feats), gv_feat + self.wctx_drop(state_word[0][1])], 1), (state_word[0][0], state_word[1][0]))
