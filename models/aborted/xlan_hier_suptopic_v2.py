...
class XLAN_HIER_SUPTOPIC_V2(AttBasicModel_HIER_TOPIC):
    def __init__(self):
        super(XLAN_HIER_SUPTOPIC_V2, self).__init__()
    ...
    def Forward(self, **kwargs):
        ...
        h_att, c_att = self.att_lstm(torch.cat([xt, old_state, gv_feat + self.ctx_drop(state[0][1])], 1), (state[0][0], state[1][0]))
